...
import {
    ...
    getAllItem,
    deleteCheckItem,
} from "./TypeOfShipService";
import TypeOfShipDialog from "./TypeOfShipDialog";
...
class TypeOfShip extends React.Component {
    state = {
        rowsPerPage: 10,
        page: 0,
        data: [],
