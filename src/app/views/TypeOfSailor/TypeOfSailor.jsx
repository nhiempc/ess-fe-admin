...
import { deleteItem, searchByPage, deleteItemList } from "./TypeOfSailorService";
    ...
    const handleConfirmationResponse = (rowData) => {
        ...
        deleteItem(itemSailor.id)
            .then(({ data }) => {
                ...
                toast.warning("general.disAllowDelete");
            });
        handleDialogClose();
    };
        ...
        <div className="m-50">
            ...
            <Card elevation={2} className="mb-16 w-100" >
                <CardHeader
                    ...
                    title={t("general.selected") + selectedList.length}
                    action={
