...
import PositionTitleDialog from "./PositionTitleDialog";
import {
...
class PositionTitle extends React.Component {
    ...
    render() {
        ...
        let columns = [
            ...
            {
                title: t("PositionTitle.description"),
                field: "description",
                minWidth: 300,
                align: "center",
                headerStyle: {
                            ...
                            <Grid item xs={12}>
                                ...
                                <MaterialTable
                                    ...
                                    parentChildData={(row, rows) => {
                                        let list = rows.find((a) => a.id === row.parent?.id);
                                        return list;
                                    }}
                                    localization={{
                                        body: {
