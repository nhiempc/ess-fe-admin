...
import { saveItem, updateItem } from "./SailorStatusService";
...
function SailorStatusDialog(props) {
    const {
        open,
        t,
        item,
    ...
    return (
        ...
        >
            ...
            >
                <h4>
                    {item?.id
                        ? t("sailorStatus.updateDialog")
                        : t("sailorStatus.addDialog")}
                </h4>
                <Button
                    aria-label="close"
                    onClick={handleClose}
...
export default SailorStatusDialog;
