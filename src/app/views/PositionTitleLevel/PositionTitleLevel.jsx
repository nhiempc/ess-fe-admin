...
import PositionTitleLevelDialog from "./PositionTitleLevelDialog";
import {
...
class PositionTitleLevel extends React.Component {
    state = {
        rowsPerPage: 10,
        page: 0,
        data: [],
    ...
    render() {
        ...
        let columns = [
            ...
            },
            {
                ...
                render: (rowData) => {
                    return moment(rowData.createDate).format('DD-MM-yyyy HH:mm:ss');
                }
            }
        ];
                ...
                <div className="mb-sm-30 pb-16" style={{ borderBottom: '1px solid #ccc' }}>
                    <Breadcrumb
                        routeSegments={[
                            ...
                            { name: t("Dashboard.PositionTitleLevelId") }
                        ]}
                    />
                </div>
...
export default PositionTitleLevel;
