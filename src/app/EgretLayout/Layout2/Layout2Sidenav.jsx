    ...
    return (
      <MuiThemeProvider theme={sidenavTheme}>
        <style>
          {`
            sidenav: {
              background-color: ${sidenavTheme.palette.primary.contrastText}
            }
            .sidenav__hold{
              color: ${sidenavTheme.palette.primary.contrastText}
            }
            .sidenav__hold .navigation .nav-item.active,
            .sidenav__hold .navigation .nav-item:hover
            {
              color: ${sidenavTheme.palette.hover.contrastText} !important
            }
          `}
        </style>
